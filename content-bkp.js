                ...
                || dArr[index].querySelector('._amk1')) 
            {
                ...
                if ( !dArr[index].classList.contains('read_ok') ) {
                   ...
                   /*  if(dArr[index].querySelector('img')) { */
                    ...
                    // VIDEO
                    } if(dArr[index].querySelector('.x10l6tqk.x1hhq9f1.xo29wiw.x1vjfegm.x1okw0bk.xh8yej3.x5yr21d.x121ad3m.xop5d2z.x1qp9xe7.x1hilzlb.xztyhrg.x18d0r48.x127lhb5.x4afe7t.xa3vuyk.x10e4vud')){
